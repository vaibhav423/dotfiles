...
return {
  ...
  n = {
    ...
    -- toggle key maps  
    ["z1"] = { function() require("personal.fold_toggle").toggle(1) end, desc = "Toggle fold level 1" },
    ["z2"] = { function() require("personal.fold_toggle").toggle(2) end, desc = "Toggle fold level 2" },
    ["z3"] = { function() require("personal.fold_toggle").toggle(3) end, desc = "Toggle fold level 3" },
    ["z4"] = { function() require("personal.fold_toggle").toggle(4) end, desc = "Toggle fold level 4" },

    -- Fold level toggles (all windows in tabpage)
    ["<Leader>z1"] = { function() require("personal.fold_toggle").toggle_all(1) end, desc = "Toggle fold level 1 (all windows)" },
    ["<Leader>z2"] = { function() require("personal.fold_toggle").toggle_all(2) end, desc = "Toggle fold level 2 (all windows)" },
    ["<Leader>z3"] = { function() require("personal.fold_toggle").toggle_all(3) end, desc = "Toggle fold level 3 (all windows)" },
    ["<Leader>z4"] = { function() require("personal.fold_toggle").toggle_all(4) end, desc = "Toggle fold level 4 (all windows)" },
  },
    -- Visual mode ---------------------------------------------------------------
  v = {
