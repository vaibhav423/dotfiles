...
return {
  ...
  opts = function(_, opts)
    ...
    opts.autocmds = vim.tbl_deep_extend("force", opts.autocmds or {}, require "lsp.autocmds")

    -- mappings to be set up on attaching of a language server
    opts.mappings = vim.tbl_deep_extend("force", opts.mappings or {}, require "lsp.mappings")
