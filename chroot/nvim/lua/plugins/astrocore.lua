      ...
      fold_persistence = {
        {
          ...
          callback = function(args) require("fold_persist").save(args.buf) end,
        },
        {
          event = "BufReadPost",
          pattern = "?*",
          desc = "Clear fold restore flag when buffer is re-read (e.g. :e)",
        ...
        },
        {
          ...
          callback = function(args) require("fold_persist").restore(args.buf) end,
        },
      },
    },
